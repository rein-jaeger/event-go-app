...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget createTextField(String hint, Widget icon, TextEditingController controller, {bool obscured = false}) {
    return SizedBox(
        height: 80,
        child: TextField(
  ...
  Widget forPortrait(BuildContext context) {
    ...
    var usernameIcon = SvgPicture.asset('assets/user_icon.svg',
      color: Colors.black54,
    );

    var passwordIcon = SvgPicture.asset('assets/password_icon.svg',
      color: Colors.black54,
    );
      ...
      child: SizedBox(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              createTextField('Enter username', usernameIcon, _usernameController),
              createTextField('Enter password', passwordIcon, _passwordController, obscured: true),
              ToggleSwitch(
                minWidth: formWidth,
                initialLabelIndex: 0,
                totalSwitches: 3,
                labels: const ['Client', 'Event Organizer', 'Service Provider'],
